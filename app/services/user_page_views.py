...
_EXACT_LABELS: Dict[str, str] = {
    ...
    "/documents/signature-editor": "Signature editor",
    "/log-hours": "Log hours",
    "/users": "Users",
    ...
    "/company-assets/work-orders": "Company assets · Work orders",
    "/company-assets/credit-cards": "Company assets · Credit cards",
    "/company-assets/credit-cards/new": "New credit card",
    "/company-assets/fuel-cards": "Company assets · Fuel cards",
    "/company-assets/fuel-cards/new": "New fuel card",
    "/training": "Training",
...
_PREFIX_LABELS: tuple[tuple[str, str], ...] = (
    ...
    ("/company-assets/work-orders/", "Work order"),
    ("/company-assets/credit-cards/", "Credit card"),
    ("/company-assets/fuel-cards/", "Fuel card"),
