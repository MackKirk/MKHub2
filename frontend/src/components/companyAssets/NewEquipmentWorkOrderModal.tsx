...
const FORM_ID = 'equipment-new-work-order-form';
...
export default function NewEquipmentWorkOrderModal({
  open,
  onClose,
  equipmentId,
  ...
  const title = equipmentDisplayName?.trim()
    ? `New work order — ${equipmentDisplayName.trim()}`
    : 'New work order';
  ...
  return (
    <AppFormModal
      ...
      quickInfo={
        <>
          <p>Create a work order linked to this equipment item.</p>
