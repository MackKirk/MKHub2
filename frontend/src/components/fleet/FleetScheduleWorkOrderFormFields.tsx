...
export type FleetScheduleWorkOrderFormValues = {
  entity_id: string;
  description: string;
  category: string;
  urgency: string;
...
type Props = {
  ...
  onChange: (field: keyof FleetScheduleWorkOrderFormValues, value: string | boolean) => void;
  onSubmit: () => void;
};

export function FleetScheduleWorkOrderFormFields({
  formId,
  values,
  disabled,
  canAssign = true,
