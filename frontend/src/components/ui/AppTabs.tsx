        ...
        return (
          ...
          >
            ...
            {typeof tab.count === 'number' ? (
              <span className={uiCx('inline-flex min-w-5 items-center justify-center px-1 text-[10px] font-semibold', uiRadius.badge, isActive ? 'bg-white/20 text-white' : 'bg-gray-100 text-gray-600')}>
                {tab.count}
              </span>
            ) : null}
          </button>
