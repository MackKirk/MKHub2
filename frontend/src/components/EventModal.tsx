          ...
          <div className="grid grid-cols-2 gap-6">
                ...
                {!isAllDay && (
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      disabled={is247}
                      className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-300 focus:border-gray-300"
                    />
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm mb-3 focus:outline-none focus:ring-1 focus:ring-gray-300 focus:border-gray-300"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm min-h-[80px] resize-y placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-300 focus:border-gray-300"
