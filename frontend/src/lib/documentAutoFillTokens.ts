...
export const DOCUMENT_AUTO_FILL_TOKENS: DocumentAutoFillTokenDef[] = [
  ...
  { token: '<Primary Contact Name>', label: 'Primary contact name', group: 'project' },
  { token: '<Primary Contact Phone>', label: 'Primary contact phone', group: 'project' },
  { token: '<Primary Contact Email>', label: 'Primary contact email', group: 'project' },
