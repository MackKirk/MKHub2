...
export const IMPLEMENTED_PERMISSIONS = new Set([
  ...
  'fuel_cards:write',
  'properties:access',
  'properties:dashboard:read',
  'properties:company:read',
  'properties:company:write',
  'properties:family:read',
  'properties:family:write',
  'properties:documents:read',
  'properties:documents:write',
  'properties:permits:read',
  'properties:permits:write',
