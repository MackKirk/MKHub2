...
export default function FleetAssetNew() {
  ...
  const canSubmit = form.name.trim().length > 0 && photos.length > 0;
    ...
    <div className="space-y-4">
      <div className="mb-3 rounded-xl border bg-gradient-to-br from-[#7f1010] to-[#a31414] text-white p-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-2xl font-extrabold">New {assetType.replace('_', ' ')}</div>
            <div className="text-sm opacity-90">Create a new fleet asset</div>
          </div>
          <button
            onClick={() => nav(-1)}
