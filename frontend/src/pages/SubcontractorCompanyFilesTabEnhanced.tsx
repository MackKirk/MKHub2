...
import { AppButton, AppCard, AppSectionHeader, appSectionPresetProps, AppCheckboxControl, AppListRowIconButton, uiCx, uiSpacing } from '@/components/ui';
    ...
    <div className={uiSpacing.sectionStack}>
      ...
      <AppCard bodyClassName="p-4">
        {isAdmin && filesSection === 'deleted' ? (
          ...
          <ProjectFilesHome
            title="Subcontractor Company Files"
            description="Browse files by category or open the complete company library."
