...
/** Default dashboard used when user has no saved layout and for "Reset to default". */
export const DEFAULT_HOME_DASHBOARD: HomeDashboardState = {
  layout: [
    ...
    { i: 'default-list-tasks', x: 2, y: 1, w: 2, h: 2 },
  ],
  widgets: [
    ...
    { id: 'default-shortcuts', type: 'shortcuts', title: 'Shortcuts', config: { items: ['tasks', 'projects', 'schedule', 'quotes'] } },
