              ...
              {tab==='personal' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <EditableGrid p={p} editable={canEdit} selfEdit={!!canSelfEdit} userId={String(userId)} fields={[['Preferred name','preferred_name'],['Gender','gender'],['Marital status','marital_status'],['Date of birth','date_of_birth'],['Nationality','nationality']]} />
                  </div>
                  <div>
                    ...
                    <AddressSection p={p} editable={canEdit} selfEdit={!!canSelfEdit} userId={String(userId)} />
                  </div>
                  <div>
                    ...
                    <EditableGrid p={p} editable={canEdit} selfEdit={!!canSelfEdit} userId={String(userId)} fields={[['Phone','phone'],['Mobile phone','mobile_phone'],['Emergency contact name','emergency_contact_name'],['Emergency contact relationship','emergency_contact_relationship'],['Emergency contact phone','emergency_contact_phone']]} />
                  </div>
                  <div>
...
function AddressSection({ p, editable, selfEdit, userId }:{ p:any, editable:boolean, selfEdit:boolean, userId:string }){
    ...
    <div>
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          {isEditable? (
            <input value={form.address_line1} onChange={e=> setForm((s:any)=>({ ...s, address_line1: e.target.value }))} className="w-full rounded-lg border px-3 py-2"/>
          ) : (
        ...
        <div>
          ...
          {isEditable? (
            <input value={form.address_line2} onChange={e=> setForm((s:any)=>({ ...s, address_line2: e.target.value }))} className="w-full rounded-lg border px-3 py-2"/>
          ) : (
        ...
        <div>
          ...
          {isEditable? (
            <input value={form.postal_code} onChange={e=> setForm((s:any)=>({ ...s, postal_code: e.target.value }))} className="w-full rounded-lg border px-3 py-2"/>
          ) : (
