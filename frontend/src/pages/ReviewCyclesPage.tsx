        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-xs font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition-colors whitespace-nowrap inline-flex items-center gap-1.5"
            >
            ...
            {hasActiveFilters ? (
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-medium text-gray-600 border border-gray-200 hover:bg-gray-50 transition-colors whitespace-nowrap"
              >
                Clear filters
              </button>
            ) : null}
