...
export default function FleetVehicles() {
  ...
  const { data: assets, isLoading } = useQuery({
    queryKey: ['fleetAssets', 'vehicle', search, statusFilter],
    queryFn: () => {
      const params = new URLSearchParams();
      params.append('asset_type', 'vehicle');
  ...
  return (
    <div className="space-y-4">
      <div className="mb-3 rounded-xl border bg-gradient-to-br from-[#7f1010] to-[#a31414] text-white p-4">
        <div className="text-2xl font-extrabold">Vehicles</div>
        <div className="text-sm opacity-90">Manage vehicle fleet</div>
      </div>
      ...
      <div className="flex gap-3 items-center">
        ...
        <button
          onClick={() => nav('/fleet/assets/new?type=vehicle')}
