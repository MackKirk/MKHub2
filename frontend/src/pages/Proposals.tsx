    ...
    <div>
      ...
      <div className="rounded-xl border bg-white overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50"><tr><th className="p-2 text-left">Title</th><th className="p-2 text-left">Order</th><th className="p-2 text-left">Created</th></tr></thead>
          <tbody>
            {isLoading? <tr><td colSpan={3} className="p-4"><div className="h-6 bg-gray-100 animate-pulse rounded"/></td></tr> : (data||[]).map(p=> (
