    ...
    try:
        ...
        hr_permissions = [
            ...
            },
            {
                ...
                "description": "Allows creating and editing users",
                "sort_index": 3,
            },
            {
                "key": "hr:users:view:general",
                "label": "View General Tab",
                "description": "Allows viewing the General tab of user details",
                "sort_index": 4,
            },
            {
                "key": "hr:users:edit:general",
                "label": "Edit General Tab",
                "description": "Allows editing the General tab of user details",
                "sort_index": 5,
            },
            {
                "key": "hr:users:view:timesheet",
                "label": "View Timesheet Tab",
                "description": "Allows viewing the Timesheet tab of user details",
                "sort_index": 6,
            },
            {
                "key": "hr:users:view:permissions",
                "label": "View Permissions Tab",
                "description": "Allows viewing the Permissions tab of user details",
                "sort_index": 7,
            },
            {
